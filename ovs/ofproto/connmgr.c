...
#ifdef _OFP_CENTEC_    
    /* XXX: maybe we can add an command option to controll this,
     * and commit this feature to ovs branch, ovs does not support
     * to turn off in_band controller currently. */
    mgr->in_band_enabled = false;
#endif
    mgr->in_band = NULL;
