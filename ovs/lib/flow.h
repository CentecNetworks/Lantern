...
/* Support QINQ */
#ifdef _OFP_CENTEC_
enum { MAX_VLAN_TAGS = 6 }; /* Maximum vlan tags can be handled */
#endif
...
struct flow {
    ...
    ovs_be16 vlan_qinq_tci[5];  /* If vlan qinq, qinq TCI | VLAN_CFI;*/
    ovs_be16 vlan_qinq_tpid[5]; /* If vlan qinq, TPID = outer tpid */
    uint8_t org_vlan_tag_count; /* vlan tag count in original packet */
