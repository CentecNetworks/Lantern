...
#define OFPACTS                                                     \
    ...
    DEFINE_OFPACT(PUSH_VLAN,       ofpact_push_mpls,     ofpact)    \
    ...
    DEFINE_OFPACT(GOTO_TABLE,      ofpact_goto_table,    ofpact)    \
                                                                    \
/* #ifdef _OFP_CENTEC_ */                                           \
    DEFINE_OFPACT(PUSH_L2,         ofpact_push_l2,       ofpact)    \
    DEFINE_OFPACT(POP_L2,          ofpact_pop_l2,        ofpact)    \
    DEFINE_OFPACT(SET_MPLS_TTL,    ofpact_set_mpls_ttl,  ofpact)    \
...
struct ofpact_push_l2 {
    struct ofpact ofpact;
};

struct ofpact_pop_l2 {
    struct ofpact ofpact;
};

struct ofpact_set_mpls_ttl {
    struct ofpact ofpact;
    uint8_t mpls_ttl;
};
