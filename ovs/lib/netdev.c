...
struct netdev_class netdev_live_class;
struct vport_class netdev_live_vport_class;
#endif
...
#ifdef _OFP_CENTEC_    
        netdev_register_provider(&netdev_live_class);
        netdev_register_provider(&netdev_live_vport_class.netdev_class);
#else
