...
{
	/* CENTEC: deleted for opensource mips toolchain, though saa is supported
       by CN5xxx (refer to octeon_feature), opensource mips toolchain does not 
       support it, by refering to vanilla kernel we can just comment this out.
    if (cpu_has_saa) {
