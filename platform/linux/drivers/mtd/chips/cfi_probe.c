...
/* Only the E330 first hardware board should set this flag.
   It use two 32M bytes flash, but each flash can only use 16M bytes 
   because of the hardware limitation  
*/
int octeon_ctc_flash_odd_usage = 0;
				   ...
				   struct cfi_private *cfi)
{
    ...
    if(octeon_ctc_flash_odd_usage)
        /* zhuj_debug hard code here */
        cfi->cfiq->DevSize = 24;
