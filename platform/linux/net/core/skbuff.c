...
static void __copy_skb_header(struct sk_buff *new, const struct sk_buff *old)
{
	...
	new->iif		= old->iif;
#if 1
    /* added by kcao 2011-07-25 for identifier MPLS-TP OAM DM PDU */
	new->icmp_rd_excp = old->icmp_rd_excp;/* added by yanxa, for peth improvement, bug 16741, 2011-11-10*/
	new->mpls_fwd_flag = old->mpls_fwd_flag;
      new->deny_dhcp_pkt_fwd = old->deny_dhcp_pkt_fwd; /*for bug 16554 added by liuyang 2012-5-2*/
#endif
	__nf_copy(new, old);
