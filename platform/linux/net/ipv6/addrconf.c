...
static struct inet6_dev * ipv6_add_dev(struct net_device *dev)
{
    ...
    /* Add all-router address. by tanker for bug2763, merged by ychen in 2011-4-14 */
...
/* don't join anycast for we still do not support anycast, by tanker for bug2834 */
#if 0
...
static void addrconf_rs_timer(unsigned long data)
{
	...
	if (ifp->probes++ < ifp->idev->cnf.rtr_solicits) {
		 ...
		 */
		 /*commented by ychen in 2012-04-18 for bug 18922*/
